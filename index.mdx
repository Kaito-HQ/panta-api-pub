...
| --- | --- |
| Production | `https://live-api.panta.market/api/v1` |
| Staging | `https://staging-api.panta.market/api/v1` |
| Development | `https://dev-api.panta.market/api/v1` |
| Test | `https://test-api.panta.market/api/v1` |

Examples in this site use the **production** host unless noted. API reference pages have an interactive **Try it** playground against that host — see [Authentication](/guides/authentication#try-it-in-these-docs).
